...
public class GameController {
    ...
    public void moveCurrentPlayerToSpace(@NotNull Space space)  {
        ...
        if (space!= null && currentPlayer!=null){
            if(space.getPlayer()==null){
                ...
                //counter metoden og getStatusMessage mangler
            }
            //board.setCurrentPlayer(space.getPlayer());
    ...
    public void moveForward(@NotNull Player player) {
        if (board !=null && player !=null && player.board==board){
            Space currentSpasce= player.getSpace();
            if(currentSpasce !=null){
                Space newSpace=board.getNeighbour(currentSpasce,player.getHeading());
